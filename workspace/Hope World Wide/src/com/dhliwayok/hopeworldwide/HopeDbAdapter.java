...
public class HopeDbAdapter {//Adapter Class to help use database
		...
		public long insertChild(int id, String name, String od, String dateOfBirth, String gender, int cntr){//inserts a child record in the database
...
public void clearAll(){
	...
	static class HopeHelper extends SQLiteOpenHelper{//Database class (Schema)
		...
		private static final String CREATE_TABLE1 = "CREATE TABLE "+ TABLE1+" ("+KEY_ID+" INTEGER (6) PRIMARY KEY, "+C_NAME+" VARCHAR (20), "+
				OD+" CHAR(1), "+DATE_OF_BIRTH+" DATE, "+GENDER+" CHAR(1), "+ CENTRE_ID+" INTEGER (3), FOREIGN KEY ("+ CENTRE_ID+") REFERENCES "+ TABLE3+" (" + CENTRE_ID+"));";
