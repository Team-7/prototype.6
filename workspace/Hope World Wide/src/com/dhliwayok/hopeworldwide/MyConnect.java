...
public class MyConnect extends AsyncTask {
    ...
    {  
        ...
        try{   
                ...
                HttpPost httppost = new HttpPost("http://team7.web44.net/sync/get_child.php");  
        ...
        // </namevaluepair> </namevaluepair> 
         ...
         try{
             ...
             for(int i=0;i<jArray.length();i++){  
                 ...
                 if (mydb.insertChild(json_data.getInt("child_id"), json_data.getString("child_name"), json_data.getString("OD"), json_data.getString("Date_Of_Birth"),json_data.getString("Gender"),json_data.getInt("centre_id"))> 0) 
                	 x = true;
             }
        	}
    ...
    {  
        ...
        try{   
                ...
                HttpClient httpclient = new DefaultHttpClient();  
                HttpPost httppost = new HttpPost("http://team7.web44.net/sync/get_cw.php");  
    ...
    try {  
        ...
        try{   
        		...
        		StringEntity se = new StringEntity(jsonarray.toString()); 
                HttpClient httpclient = new DefaultHttpClient();  
                HttpPost httppost = new HttpPost("http://team7.web44.net/sync/get_mychildBmi.php");  
                httppost.setEntity(se);  
                HttpResponse response = httpclient.execute(httppost);  
                HttpEntity entity = response.getEntity();  
                is = entity.getContent();  
      ...
      try {  
        ...
        try{   
               ...
               // ArrayList<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();  
        	    StringEntity se = new StringEntity(jsonarray.toString()); 
                HttpClient httpclient = new DefaultHttpClient();  
                HttpPost httppost = new HttpPost("http://team7.web44.net/sync/get_mybmi.php");  
                httppost.setEntity(se);  
                HttpResponse response = httpclient.execute(httppost);  
                HttpEntity entity = response.getEntity();  
                is = entity.getContent();  
    ...
    {  
        ...
        try{   
                ...
                HttpClient httpclient = new DefaultHttpClient();  
                HttpPost httppost = new HttpPost("http://team7.web44.net/sync/get_cc.php");  
                httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs));  
                HttpResponse response = httpclient.execute(httppost);  
                HttpEntity entity = response.getEntity();  
                is = entity.getContent();  
